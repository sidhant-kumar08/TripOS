...
import { Compass, LogOut, LayoutDashboard, Menu, X, ArrowRight } from 'lucide-react';
            ...
            {isAuthenticated ? (
              <div className="flex items-center gap-2 pl-1">
                ...
                <button
                  ...
                  className="flex items-center gap-1 rounded-full px-3 py-1.5 text-xs font-medium text-slate-600 hover:text-red-600 hover:bg-red-50/60 dark:text-slate-300 dark:hover:text-red-400 dark:hover:bg-red-950/40 transition"
                  title="Log out"
                >
